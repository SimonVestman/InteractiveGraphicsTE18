...
public class Graphics extends Canvas implements Runnable {
    ...
    private int xcirkel1 = 0;
    private int ycirkel1 = 0;
    private int vxcirkel1 = 0;
    private int vycirkel1 = 0;
    ...
    private void update() {
        ...
        */
        ...
        // The moving magenta cirkel
        if (xcirkel1 + vxcirkel1 < 0 || xcirkel1 + vxcirkel1 > width - cirkel1.getWidth())
            vxcirkel1 = 0;
        if (ycirkel1 + vycirkel1 < 0 || ycirkel1 + vycirkel1 > height - cirkel1.getHeight())
            vycirkel1 = 0;

        xcirkel1 += vxcirkel1;
        ycirkel1 += vycirkel1;

        for (int i = 0 ; i < cirkel1.getHeight() ; i++) {
            for (int j = 0 ; j < cirkel1.getWidth() ; j++) {
                pixels[(ycirkel1+i)*width + xcirkel1+j] = cirkel1.getPixels()[i*cirkel1.getWidth()+j];
            }
        }
